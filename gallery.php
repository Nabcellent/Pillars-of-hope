...
<html lang="en-gb">
	...
	<body>
		<center>
			<img src="img/images/logo.png" alt=""><br><br>
			<div id="dropZone">
		...
		<script src="js/gallery%20js/jquery.iframe-transport.js" type="text/javascript"></script>
		<script src="js/gallery%20js/jquery.fileupload.js" type="text/javascript"></script>
               ...
               $("#fileupload").fileupload({
                   ...
                   if (!fileTypeAllowed.test(fileName))
                    ...
                    if (status == 1) {
                        ...
                        $("#files").fadeIn().append('<p><img style="width: 100px; height: 100px;" src="'+path+'"  alt=""/></p>');
                    } else
                        $("#error").html(msg);
